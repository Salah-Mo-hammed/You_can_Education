...
import 'package:grad_project_ver_1/core/services/notifications.dart';
    ...
    if (user != null) {
      ...
      if (userDoc.exists) {
        ...
        if (role == "student" && isCompletedInfo == true) {
          ...
          await NotificationService().initFirebaseMessaging(user.uid);
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => CenterDashboard(centerId: user.uid),
            ),
          );
        ...
        child: Container(
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage("assets/images/background_final.png"), // Your background
              fit: BoxFit.cover,
            ),
          ),
          child: SafeArea(
            child: Center(
              child: AnimatedOpacity(
                ...
                child: SizedBox(
                  ...
                  height: 200,
                  child: Image.asset(
                    'assets/images/logofinal.png', // Your YC YouCan logo
                    fit: BoxFit.contain,
                  ),
                ),
              ),
